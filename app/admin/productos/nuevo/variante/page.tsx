          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-[0.82fr_1.18fr]">
            ...
            <section className="rounded-[10px] border border-[#E7BFC9] bg-white p-7">
              ...
              <div className="space-y-7">
                ...
                <label className="block"><span className="text-[15px] font-bold tracking-wide text-[#6B6063]">Valor</span><input name="value" required placeholder="Ej. 50ml / #9E3659 / Rosa" className="mt-3 h-14 w-full rounded-[8px] border border-[#E7BFC9] bg-[#FFFCFC] px-5 text-[18px] outline-none focus:border-[#9E3659]" /></label>
